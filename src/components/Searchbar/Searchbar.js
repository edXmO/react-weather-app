...
const Searchbar = ({ handleTextApiReq, handleGeoLocApiReq, theme }) => {
    ...
    return (
        <div className={`searchbar ${activeTheme}`}>
            <IconBtn
                handleIconClick={handleGeoLocClick}
                btnStyle="btn-inv btn-inv-lf"
                children={<LocationIcon className="searchbar__icon" />}
            />
                ...
                <form onSubmit={handleSubmit}>
                    <label className="input-box__label">
                        ...
                        <input
                            ...
                            className={`input-box__input ${activeTheme}`}
                            type="text"
                            placeholder=""
                        />
                    </label>
            ...
            <IconBtn
                handleIconClick={handleAboutInfo}
                btnStyle="btn-inv"
                children={
                    <InfoIcon className="searchbar__icon searchbar__icon--info" />
                }
            />
        </div>
    );
